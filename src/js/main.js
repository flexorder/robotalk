...
supported_languages = ["en-US", "de-DE", "zh-CN", "ko-KR"] //"ar-AE"] // ["en-US", "de-DE", "zh-CN", "ko-KR"] //  ja-JP The language detection engine supports a maximum of 4 languages
...
window.startRecording = () => {
  const speechConfig = SpeechSDK.SpeechConfig.fromAuthorizationToken(token, 'southeastasia'); //ken 'westeurope');
